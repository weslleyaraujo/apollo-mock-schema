...
That's the main component which will mainly wrap your application (or a single component) and mock results
...
| `children`          | `React.ReactNode | React.ReactElement<any>` | `true`   | The application/component to be tested                                                                                                                                                                                                                                                                                                                                                                                                                                      |
